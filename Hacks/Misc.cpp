...
void Misc::updateClanTag(bool tagChanged) noexcept
{
	...
	if (config.misc.customClanTag) {
		...
		i++;
		if (i == 1) clanTag = config.misc.clanTag;
		if (i > 2) i = 2;
...
void Misc::watermark() noexcept
{
			...
			config.GlobalFPS = static_cast<int>(1 / frameRate);
			config.GlobalScreenWidth = screenWidth;

			float latency = 0.0f;
			if (auto networkChannel = interfaces.engine->getNetworkChannel(); networkChannel && networkChannel->getLatency(0) > 0.0f)
				config.GlobalPing = networkChannel->getLatency(0);
}
...
bool Misc::fakevote(bool set) noexcept
{
	...
	if (shouldSet && interfaces.engine->isInGame() && changeName(false, std::string{ "\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n" }.append(std::string{ static_cast<char>(config.misc.banColor + 1) }).append(config.misc.voteText).append("\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n").c_str(), 5.0f))
		shouldSet = false;
