...
namespace ImGui
{
	...
	IMGUI_API bool          Button(const char* label, const ImVec2& size = ImVec2(0, 0));    // buttonto query widget state.
    IMGUI_API bool          Button2(const char* label, const ImVec2& size = ImVec2(0, 0));    // button
...
struct ImFontAtlas
{
	...
	IMGUI_API ImFont* AddFontIcon(const ImFontConfig* font_cfg = NULL);
